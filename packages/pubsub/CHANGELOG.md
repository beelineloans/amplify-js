...
- **@aws-amplify/pubsub:** call observer.error on disconnect for MqttOverWSProvider ([0795db6](https://github.com/aws-amplify/amplify-js/commit/0795db65bb9484bf8428d25b4d857fad448194d2))
- **@aws-amplify/pubsub:** catch and throw the error when subscribing using Mqtt ([#3376](https://github.com/aws-amplify/amplify-js/issues/3376)) ([08ce6eb](https://github.com/aws-amplify/amplify-js/commit/08ce6ebad90eaea8b7ec486fc7a1a8daec697ced))
- **@aws-amplify/pubsub:** correctly match # and + wildcards in message topic ([#2008](https://github.com/aws-amplify/amplify-js/issues/2008)) ([522372e](https://github.com/aws-amplify/amplify-js/commit/522372e23b6d8504c3f10a08cde7dfe213f21e26))
- **@aws-amplify/pubsub:** fix the typescript error ([#3461](https://github.com/aws-amplify/amplify-js/issues/3461)) ([3497986](https://github.com/aws-amplify/amplify-js/commit/34979861d8115b876d82b9997aa2550074c4fd03))
...
- **@aws-amplify/pubsub:** paho-mqtt typescript ([#1821](https://github.com/aws-amplify/amplify-js/issues/1821)) ([4d0802c](https://github.com/aws-amplify/amplify-js/commit/4d0802c53d13d4467d46a644fd0bd61ca23461db))
...
- **@aws-amplify/pubsub:** sending connection error to observable on AWSAppSyncProvider ([8b7cac7](https://github.com/aws-amplify/amplify-js/commit/8b7cac7200e3a5bdd9ff762e82de87d6cd34fe82))
...
- **pubsub,appsync:** Fix NPE when unsubscribing ([#1955](https://github.com/aws-amplify/amplify-js/issues/1955)) ([e651728](https://github.com/aws-amplify/amplify-js/commit/e65172857abbb916b52237c81b14ed0f50a83eba)), closes [#1940](https://github.com/aws-amplify/amplify-js/issues/1940)
...
- Remove cpx dependency from pubsub ([#11752](https://github.com/aws-amplify/amplify-js/issues/11752)) ([c6cb690](https://github.com/aws-amplify/amplify-js/commit/c6cb6901cd751481011d08ae08be235374e56308))
...
- Revert "fix: AWSAppSyncRealTimeProvider websocket init fix" ([b5819c5](https://github.com/aws-amplify/amplify-js/commit/b5819c59dfb517ad4db8de57729821894d8c6eb9))
