...
- **@aws-amplify/analytics:** abort recording events when lacking of application id or region ([b2b631b](https://github.com/aws-amplify/amplify-js/commit/b2b631bd204a55138562b4854a5b0f57b7bdd738))
...
- **@aws-amplify/analytics:** Auto session tracking after Auth is configured ([ce31f57](https://github.com/aws-amplify/amplify-js/commit/ce31f577281cb6b324686e7200c3149905e9ea0c))
- **@aws-amplify/analytics:** avoid return statement in the beforeunload function ([2b6e95e](https://github.com/aws-amplify/amplify-js/commit/2b6e95ea8c2fa6ab0fe190ed1a6df6c02341adb0))
...
- **@aws-amplify/analytics:** check the environment before running dom-utils ([4375b21](https://github.com/aws-amplify/amplify-js/commit/4375b219f79b1b4c4d56bbc0a74151ee51341706))
- **@aws-amplify/analytics:** clear timer when analytics is disabled ([5d1370d](https://github.com/aws-amplify/amplify-js/commit/5d1370d92fe19f41174fe51e6c3b630850487708))
- **@aws-amplify/analytics:** do not send events when analytics modules not configured ([#3614](https://github.com/aws-amplify/amplify-js/issues/3614)) ([82e6f28](https://github.com/aws-amplify/amplify-js/commit/82e6f28379bb90d7c543f818315d08ba21980b9e))
- **@aws-amplify/analytics:** fix the event name of session start/stop ([12f4e6f](https://github.com/aws-amplify/amplify-js/commit/12f4e6f9b912830dba0f260c4c49797d2a2b9e09))
- **@aws-amplify/analytics:** fix the type definition ([34daec2](https://github.com/aws-amplify/amplify-js/commit/34daec24f28fafd462f2738bc86d38888bc9d193))
- **@aws-amplify/analytics:** generate endpoint id if not provided ([cca9d2f](https://github.com/aws-amplify/amplify-js/commit/cca9d2f6f76ff091b60fbee079cb64f4ace0e6a8))
- **@aws-amplify/analytics:** manual version bump ([b347e0d](https://github.com/aws-amplify/amplify-js/commit/b347e0d32215694872769877b39c53563c8d597b))
- **@aws-amplify/analytics:** prevent sending reqeusts simultaneously if endpoint is not generated yet ([8a7d7cc](https://github.com/aws-amplify/amplify-js/commit/8a7d7ccd8104b2dfc67e07152e90884ac3d20ceb))
- **@aws-amplify/analytics:** resolve/reject correctly when calling reocrd ([c3eb6cc](https://github.com/aws-amplify/amplify-js/commit/c3eb6cc44f0576268acf758b92746136fe139b72))
...
- **@aws-amplify/analytics:** send session stop events when app turns into background/inactive ([e2e9b66](https://github.com/aws-amplify/amplify-js/commit/e2e9b66a0c465b99081138a837f42403630f04d0))
- **@aws-amplify/analytics:** unlink user id from endpoint when limit exceeds ([b2de140](https://github.com/aws-amplify/amplify-js/commit/b2de140402e61942f371e4a5481fe143ed099a5c))
- **@aws-amplify/analytics:** use the correct user id when unlinking endpoints ([acb955f](https://github.com/aws-amplify/amplify-js/commit/acb955fd0426db0c3a53774acc10b92434c316d4))
...
- **@aws-amplify/pushnotification:** send campaign open events when app is opend by notification ([d21d4fe](https://github.com/aws-amplify/amplify-js/commit/d21d4fe25ccb5399479a5e78d869cf7a75776a3d))
...
- **@aws-amplify/analytics:** allow users to fully configure pinpoint endpoint ([55727cf](https://github.com/aws-amplify/amplify-js/commit/55727cfafba4e29632acfcec8af6020bdd42ec71))
- **@aws-amplify/analytics:** Analytics auto tracking ([585edf2](https://github.com/aws-amplify/amplify-js/commit/585edf21f4d509e2c7373ab6eeddd258e5074a91))
...
- **aws-amplify/analytics:** using Pinpoint New API ([f8e60c1](https://github.com/aws-amplify/amplify-js/commit/f8e60c13f8b0189315ccd4ad3e8b10b4301dbd97))
