import { utils, isModelAttributeAuth, isGraphQLScalarType, isModelFieldType, isTargetNameAssociation, isPredicateGroup, isPredicateObj, QueryOne } from '@aws-amplify/datastore';
