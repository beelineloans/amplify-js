...
function generateGraphQLDocument(modelIntrospection, modelDefinition, modelOperation, listArgs, indexMeta) {
    ...
    if (operationPrefix) {
        ...
        if (sk.length === 1) {
            ...
            skQueryArgs = {
                [compositeSkArgName]: `Model${(0,_utils_stringTransformation_mjs__WEBPACK_IMPORTED_MODULE_1__.capitalize)(name)}${(0,_utils_stringTransformation_mjs__WEBPACK_IMPORTED_MODULE_1__.capitalize)(keyName)}CompositeKeyConditionInput`,
            };
        }
        indexQueryArgs = {
    ...
    const generateSkArgs = (op) => {
        ...
        if (op === 'get') {
            ...
            if (sortKeyFieldNames.length === 1) {
                ...
                return {
                    [compositeSkArgName]: `Model${(0,_utils_stringTransformation_mjs__WEBPACK_IMPORTED_MODULE_1__.capitalize)(name)}PrimaryCompositeKeyConditionInput`,
                };
            }
        }
    };
...
const deserializeDocumentBlock = ({ document }) => ({
    document: {
        ...
        source: {
            ...document.source,
            bytes: (0,_smithy_util_base64__WEBPACK_IMPORTED_MODULE_0__.fromBase64)(document.source.bytes),
        },
    },
});
...
const serializeDocumentBlock = ({ document, }) => ({
    document: {
        ...
        source: {
            ...document.source,
            bytes: (0,_smithy_util_base64__WEBPACK_IMPORTED_MODULE_0__.toBase64)(document.source.bytes),
        },
    },
});
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   convertItemToConversationStreamEvent: () => (/* binding */ convertItemToConversationStreamEvent)
/* harmony export */ });
// Copyright Amazon.com, Inc. or its affiliates. All Rights Reserved.
// SPDX-License-Identifier: Apache-2.0
...
/* harmony import */ var _createOnStreamEventFunction_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./createOnStreamEventFunction.mjs */ "../../node_modules/@aws-amplify/data-schema/dist/esm/runtime/internals/ai/createOnStreamEventFunction.mjs");
...
const convertItemToConversation = (client, modelIntrospection, conversationId, conversationCreatedAt, conversationUpdatedAt, conversationRouteName, conversationMessageModel, getInternals, conversationMetadata, conversationName) => {
    ...
    return {
        ...
        onStreamEvent: (0,_createOnStreamEventFunction_mjs__WEBPACK_IMPORTED_MODULE_1__.createOnStreamEventFunction)(client, modelIntrospection, conversationId, conversationRouteName, getInternals),
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   createOnStreamEventFunction: () => (/* binding */ createOnStreamEventFunction)
/* harmony export */ });
...
/* harmony import */ var _getCustomUserAgentDetails_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./getCustomUserAgentDetails.mjs */ "../../node_modules/@aws-amplify/data-schema/dist/esm/runtime/internals/ai/getCustomUserAgentDetails.mjs");
/* harmony import */ var _conversationStreamEventDeserializers_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./conversationStreamEventDeserializers.mjs */ "../../node_modules/@aws-amplify/data-schema/dist/esm/runtime/internals/ai/conversationStreamEventDeserializers.mjs");
...
const createOnStreamEventFunction = (client, modelIntrospection, conversationId, conversationRouteName, getInternals) => (handler) => {
    ...
    const subscribeOperation = (0,_operations_custom_mjs__WEBPACK_IMPORTED_MODULE_0__.customOpFactory)(client, modelIntrospection, 'subscription', subscribeSchema, false, getInternals, (0,_getCustomUserAgentDetails_mjs__WEBPACK_IMPORTED_MODULE_1__.getCustomUserAgentDetails)(_getCustomUserAgentDetails_mjs__WEBPACK_IMPORTED_MODULE_1__.AiAction.OnStreamEvent));
    return subscribeOperation({ conversationId }).subscribe((data) => {
        const { next, error } = (0,_conversationStreamEventDeserializers_mjs__WEBPACK_IMPORTED_MODULE_2__.convertItemToConversationStreamEvent)(data);
        if (error)
            handler.error(error);
        if (next)
            handler.next(next);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   createUpdateConversationFunction: () => (/* binding */ createUpdateConversationFunction)
/* harmony export */ });
/* harmony import */ var _operations_get_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../operations/get.mjs */ "../../node_modules/@aws-amplify/data-schema/dist/esm/runtime/internals/operations/get.mjs");
/* harmony import */ var _convertItemToConversation_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./convertItemToConversation.mjs */ "../../node_modules/@aws-amplify/data-schema/dist/esm/runtime/internals/ai/convertItemToConversation.mjs");
/* harmony import */ var _getCustomUserAgentDetails_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./getCustomUserAgentDetails.mjs */ "../../node_modules/@aws-amplify/data-schema/dist/esm/runtime/internals/ai/getCustomUserAgentDetails.mjs");
...
const createUpdateConversationFunction = (client, modelIntrospection, conversationRouteName, conversationModel, conversationMessageModel, getInternals) => async ({ id, metadata: metadataObject, name }) => {
    const metadata = JSON.stringify(metadataObject);
    const updateOperation = (0,_operations_get_mjs__WEBPACK_IMPORTED_MODULE_0__.getFactory)(client, modelIntrospection, conversationModel, 'UPDATE', getInternals, false, (0,_getCustomUserAgentDetails_mjs__WEBPACK_IMPORTED_MODULE_2__.getCustomUserAgentDetails)(_getCustomUserAgentDetails_mjs__WEBPACK_IMPORTED_MODULE_2__.AiAction.UpdateConversation));
...
function _get(client, modelIntrospection, model, arg, options, operation, getInternals, context, customUserAgentDetails) {
    return (0,_utils_selfAwareAsync_mjs__WEBPACK_IMPORTED_MODULE_2__.selfAwareAsync)(async (resultPromise) => {
        const { name } = model;
        const query = (0,_APIClient_mjs__WEBPACK_IMPORTED_MODULE_0__.generateGraphQLDocument)(modelIntrospection, model, operation, options);
...
function _indexQuery(client, modelIntrospection, model, indexMeta, getInternals, args, contextSpec) {
    return (0,_utils_selfAwareAsync_mjs__WEBPACK_IMPORTED_MODULE_2__.selfAwareAsync)(async (resultPromise) => {
        const { name } = model;
        const query = (0,_APIClient_mjs__WEBPACK_IMPORTED_MODULE_0__.generateGraphQLDocument)(modelIntrospection, model, 'INDEX_QUERY', args, indexMeta);
...
function _list(client, modelIntrospection, model, getInternals, args, contextSpec, customUserAgentDetails) {
    return (0,_utils_selfAwareAsync_mjs__WEBPACK_IMPORTED_MODULE_2__.selfAwareAsync)(async (resultPromise) => {
        const { name } = model;
        const query = (0,_APIClient_mjs__WEBPACK_IMPORTED_MODULE_0__.generateGraphQLDocument)(modelIntrospection, model, 'LIST', args);
...
function subscriptionFactory(client, modelIntrospection, model, operation, getInternals) {
    ...
    const subscription = (args) => {
        const query = (0,_APIClient_mjs__WEBPACK_IMPORTED_MODULE_0__.generateGraphQLDocument)(modelIntrospection, model, operation, args);
...
/* harmony import */ var _ai_createUpdateConversationFunction_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../ai/createUpdateConversationFunction.mjs */ "../../node_modules/@aws-amplify/data-schema/dist/esm/runtime/internals/ai/createUpdateConversationFunction.mjs");
...
function generateConversationsProperty(client, apiGraphQLConfig, getInternals) {
    ...
    for (const { name, conversation, message, models, nonModels, enums, } of Object.values(modelIntrospection.conversations)) {
        ...
        conversations[name] = {
            update: (0,_ai_createUpdateConversationFunction_mjs__WEBPACK_IMPORTED_MODULE_4__.createUpdateConversationFunction)(client, conversationModelIntrospection, name, conversationModel, conversationMessageModel, getInternals),
...
/* harmony export */ });
/* harmony import */ var _aws_amplify_core_internals_utils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @aws-amplify/core/internals/utils */ "../core/dist/esm/constants.mjs");
...
/* harmony import */ var _constants_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../constants.mjs */ "../api-graphql/dist/esm/Providers/constants.mjs");
...
/* harmony import */ var _AWSWebSocketProvider_authHeaders_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../AWSWebSocketProvider/authHeaders.mjs */ "../api-graphql/dist/esm/Providers/AWSWebSocketProvider/authHeaders.mjs");
/* harmony import */ var _internals_events_utils_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../internals/events/utils.mjs */ "../api-graphql/dist/esm/internals/events/utils.mjs");
...
class AWSAppSyncEventProvider extends _AWSWebSocketProvider_index_mjs__WEBPACK_IMPORTED_MODULE_0__.AWSWebSocketProvider {
    ...
    async _prepareSubscriptionPayload({ options, subscriptionId, customUserAgentDetails, additionalCustomHeaders, libraryConfigHeaders, publish, }) {
        const { appSyncGraphqlEndpoint, authenticationType, query, apiKey, region, variables, host, } = options;
        const data = {
            channel: query,
            events: variables !== undefined ? (0,_internals_events_utils_mjs__WEBPACK_IMPORTED_MODULE_1__.serializeEvents)(variables) : undefined,
        };
        const serializedData = JSON.stringify(data);
        const headers = {
            ...(await (0,_AWSWebSocketProvider_authHeaders_mjs__WEBPACK_IMPORTED_MODULE_2__.awsRealTimeHeaderBasedAuth)({
                apiKey,
            ...
            ...additionalCustomHeaders,
            [_aws_amplify_core_internals_utils__WEBPACK_IMPORTED_MODULE_3__.USER_AGENT_HEADER]: (0,_aws_amplify_core_internals_utils__WEBPACK_IMPORTED_MODULE_4__.getAmplifyUserAgent)(customUserAgentDetails),
        };
        const subscriptionMessage = {
            ...
            type: publish
                ? _constants_mjs__WEBPACK_IMPORTED_MODULE_5__.MESSAGE_TYPES.EVENT_PUBLISH
                : _constants_mjs__WEBPACK_IMPORTED_MODULE_5__.MESSAGE_TYPES.EVENT_SUBSCRIBE,
        };
    ...
    _handleSubscriptionData(message) {
        ...
        if (type === _constants_mjs__WEBPACK_IMPORTED_MODULE_5__.MESSAGE_TYPES.DATA && payload) {
    ...
    _unsubscribeMessage(subscriptionId) {
        return {
            id: subscriptionId,
            type: _constants_mjs__WEBPACK_IMPORTED_MODULE_5__.MESSAGE_TYPES.EVENT_STOP,
        };
    }
    _extractConnectionTimeout(data) {
        const { connectionTimeoutMs = _constants_mjs__WEBPACK_IMPORTED_MODULE_5__.DEFAULT_KEEP_ALIVE_TIMEOUT } = data;
...
const awsRealTimeHeaderBasedAuth = async ({ apiKey, authenticationType, canonicalUri, appSyncGraphqlEndpoint, region, additionalCustomHeaders, payload, host: optionsHost, }) => {
    const headerHandler = {
...
class AWSWebSocketProvider {
        ...
        return new rxjs__WEBPACK_IMPORTED_MODULE_7__.Observable(observer => {
            if (!options?.appSyncGraphqlEndpoint) {
                observer.error({
                    errors: [
                        {
                            ...new graphql__WEBPACK_IMPORTED_MODULE_0__.GraphQLError(`Subscribe only available for AWS AppSync endpoint`),
                        },
                    ],
                });
                observer.complete();
    ...
    async _connectWebSocket(options) {
        const { apiKey, appSyncGraphqlEndpoint, authenticationType, region, host } = options;
    ...
    _initializeWebSocketConnection({ appSyncGraphqlEndpoint, authenticationType, apiKey, region, additionalCustomHeaders, host, }) {
        if (this.socketStatus === _constants_mjs__WEBPACK_IMPORTED_MODULE_3__.SOCKET_STATUS.READY) {
            return;
        }
    ...
    _registerWebsocketHandlers(connectionTimeoutMs) {
        ...
        }, _constants_mjs__WEBPACK_IMPORTED_MODULE_3__.DEFAULT_KEEP_ALIVE_HEARTBEAT_TIMEOUT);
...
/* harmony export */   DEFAULT_KEEP_ALIVE_HEARTBEAT_TIMEOUT: () => (/* binding */ DEFAULT_KEEP_ALIVE_HEARTBEAT_TIMEOUT),
...
/* harmony import */ var _aws_amplify_core_internals_utils__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @aws-amplify/core/internals/utils */ "../core/dist/esm/utils/amplifyUrl/index.mjs");
/* harmony import */ var _aws_amplify_core_internals_utils__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @aws-amplify/core/internals/utils */ "../core/dist/esm/Platform/index.mjs");
...
/* harmony import */ var _Providers_AWSAppSyncRealTimeProvider_index_mjs__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../Providers/AWSAppSyncRealTimeProvider/index.mjs */ "../api-graphql/dist/esm/Providers/AWSAppSyncRealTimeProvider/index.mjs");
/* harmony import */ var _utils_resolveConfig_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils/resolveConfig.mjs */ "../api-graphql/dist/esm/utils/resolveConfig.mjs");
/* harmony import */ var _utils_resolveLibraryOptions_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../utils/resolveLibraryOptions.mjs */ "../api-graphql/dist/esm/utils/resolveLibraryOptions.mjs");
/* harmony import */ var _utils_errors_repackageAuthError_mjs__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../utils/errors/repackageAuthError.mjs */ "../api-graphql/dist/esm/utils/errors/repackageAuthError.mjs");
/* harmony import */ var _utils_errors_constants_mjs__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../utils/errors/constants.mjs */ "../api-graphql/dist/esm/utils/errors/constants.mjs");
/* harmony import */ var _utils_errors_GraphQLApiError_mjs__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../utils/errors/GraphQLApiError.mjs */ "../api-graphql/dist/esm/utils/errors/GraphQLApiError.mjs");
/* harmony import */ var _utils_errors_createGraphQLResultWithError_mjs__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../utils/errors/createGraphQLResultWithError.mjs */ "../api-graphql/dist/esm/utils/errors/createGraphQLResultWithError.mjs");
/* harmony import */ var _utils_runtimeTypeGuards_isGraphQLResponseWithErrors_mjs__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./utils/runtimeTypeGuards/isGraphQLResponseWithErrors.mjs */ "../api-graphql/dist/esm/internals/utils/runtimeTypeGuards/isGraphQLResponseWithErrors.mjs");
/* harmony import */ var _graphqlAuth_mjs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./graphqlAuth.mjs */ "../api-graphql/dist/esm/internals/graphqlAuth.mjs");
...
class InternalGraphQLAPIClass {
    ...
    async _graphql(amplify, { query, variables, authMode: authModeOverride, endpoint: endpointOverride, apiKey: apiKeyOverride, }, additionalHeaders = {}, abortController, customUserAgentDetails, authToken) {
        const { apiKey, region, endpoint: appSyncGraphqlEndpoint, customEndpoint, customEndpointRegion, defaultAuthMode, } = (0,_utils_resolveConfig_mjs__WEBPACK_IMPORTED_MODULE_3__.resolveConfig)(amplify);
         ...
         * individual requests.
         */
        const { headers: customHeaders, withCredentials } = (0,_utils_resolveLibraryOptions_mjs__WEBPACK_IMPORTED_MODULE_4__.resolveLibraryOptions)(amplify);
        /**
        ...
        if (typeof additionalHeaders === 'function') {
            const requestOptions = {
                method: 'POST',
                url: new _aws_amplify_core_internals_utils__WEBPACK_IMPORTED_MODULE_5__.AmplifyUrl(endpointOverride || customEndpoint || appSyncGraphqlEndpoint || '').toString(),
        ...
        const authHeaders = await (0,_graphqlAuth_mjs__WEBPACK_IMPORTED_MODULE_6__.headerBasedAuth)(amplify, authMode, apiKeyOverride ?? apiKey, additionalCustomHeaders);
        const headers = {
            ...
            // User agent headers:
            ...(!customEndpoint && {
                [USER_AGENT_HEADER]: (0,_aws_amplify_core_internals_utils__WEBPACK_IMPORTED_MODULE_7__.getAmplifyUserAgent)(customUserAgentDetails),
            }),
        };
        const body = {
            query: (0,graphql__WEBPACK_IMPORTED_MODULE_0__.print)(query),
        ...
        if (!endpoint) {
            throw (0,_utils_errors_createGraphQLResultWithError_mjs__WEBPACK_IMPORTED_MODULE_8__.createGraphQLResultWithError)(new _utils_errors_GraphQLApiError_mjs__WEBPACK_IMPORTED_MODULE_9__.GraphQLApiError(_utils_errors_constants_mjs__WEBPACK_IMPORTED_MODULE_10__.NO_ENDPOINT));
        }
        let response;
        try {
            ...
            const { body: responseBody } = await this._api.post(amplify, {
                url: new _aws_amplify_core_internals_utils__WEBPACK_IMPORTED_MODULE_5__.AmplifyUrl(endpoint),
                options: {
                    headers,
                    body,
                    signingServiceInfo,
            ...
            response = (0,_utils_errors_createGraphQLResultWithError_mjs__WEBPACK_IMPORTED_MODULE_8__.createGraphQLResultWithError)(error);
        }
        if ((0,_utils_runtimeTypeGuards_isGraphQLResponseWithErrors_mjs__WEBPACK_IMPORTED_MODULE_11__.isGraphQLResponseWithErrors)(response)) {
            throw (0,_utils_errors_repackageAuthError_mjs__WEBPACK_IMPORTED_MODULE_12__.repackageUnauthorizedError)(response);
        }
        return response;
    }
    /**
    ...
    _graphqlSubscribe(amplify, { query, variables, authMode: authModeOverride, apiKey: apiKeyOverride, endpoint, }, additionalHeaders = {}, customUserAgentDetails, authToken) {
        const config = (0,_utils_resolveConfig_mjs__WEBPACK_IMPORTED_MODULE_3__.resolveConfig)(amplify);
         ...
         */
        const { headers: libraryConfigHeaders } = (0,_utils_resolveLibraryOptions_mjs__WEBPACK_IMPORTED_MODULE_4__.resolveLibraryOptions)(amplify);
        ...
        const realtimeProvider = this.appSyncRealTime.get(memoKey) ?? new _Providers_AWSAppSyncRealTimeProvider_index_mjs__WEBPACK_IMPORTED_MODULE_13__.AWSAppSyncRealTimeProvider();
        ...
        return realtimeProvider
            ...
            if (e.errors) {
                throw (0,_utils_errors_repackageAuthError_mjs__WEBPACK_IMPORTED_MODULE_12__.repackageUnauthorizedError)(e);
            }
            throw e;
        }));
    }
...
/* harmony import */ var _appsyncRequest_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./appsyncRequest.mjs */ "../api-graphql/dist/esm/internals/events/appsyncRequest.mjs");
...
async function connect(channel, options) {
    ...
    const channelId = (0,_aws_amplify_core_internals_utils__WEBPACK_IMPORTED_MODULE_3__.amplifyUuid)();
    ...
    const pub = async (event, pubOptions) => {
        ...
        publishOptions.authenticationType = (0,_utils_mjs__WEBPACK_IMPORTED_MODULE_1__.normalizeAuth)(pubOptions?.authMode, publishOptions.authenticationType);
        ...
        return _Providers_AWSAppSyncEventsProvider_index_mjs__WEBPACK_IMPORTED_MODULE_2__.AppSyncEventProvider.publish(publishOptions);
    };
    const close = async () => {
        ...
        setTimeout(() => {
            if (openChannels.size === 0) {
                _Providers_AWSAppSyncEventsProvider_index_mjs__WEBPACK_IMPORTED_MODULE_2__.AppSyncEventProvider.closeIfNoActiveSubscription();
            }
        }, 1000);
    };
    return {
...
async function post(channel, event, options) {
    ...
    const abortController = new AbortController();
    const res = await (0,_appsyncRequest_mjs__WEBPACK_IMPORTED_MODULE_4__.appsyncRequest)(_aws_amplify_core__WEBPACK_IMPORTED_MODULE_0__.Amplify, publishOptions, {}, abortController);
...
function generateClient(params) {
    const client = {
        ...
        [_types_index_mjs__WEBPACK_IMPORTED_MODULE_2__.__apiKey]: 'apiKey' in params ? params.apiKey : undefined,
        [_types_index_mjs__WEBPACK_IMPORTED_MODULE_2__.__endpoint]: 'endpoint' in params ? params.endpoint : undefined,
    ...
    if (client[_types_index_mjs__WEBPACK_IMPORTED_MODULE_2__.__endpoint]) {
        if (!client[_types_index_mjs__WEBPACK_IMPORTED_MODULE_2__.__authMode]) {
            throw new Error('generateClient() requires an explicit `authMode` when `endpoint` is provided.');
        }
        if (client[_types_index_mjs__WEBPACK_IMPORTED_MODULE_2__.__authMode] === 'apiKey' && !client[_types_index_mjs__WEBPACK_IMPORTED_MODULE_2__.__apiKey]) {
...
/***/ "../api-rest/dist/esm/apis/common/baseHandlers/authenticatedHandler.mjs":
/*!******************************************************************************!*\
  !*** ../api-rest/dist/esm/apis/common/baseHandlers/authenticatedHandler.mjs ***!
  \******************************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _aws_amplify_core_internals_aws_client_utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @aws-amplify/core/internals/aws-client-utils */ "../core/dist/esm/clients/handlers/fetch.mjs");
/* harmony import */ var _aws_amplify_core_internals_aws_client_utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @aws-amplify/core/internals/aws-client-utils */ "../core/dist/esm/clients/middleware/userAgent/middleware.mjs");
/* harmony import */ var _aws_amplify_core_internals_aws_client_utils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @aws-amplify/core/internals/aws-client-utils */ "../core/dist/esm/clients/middleware/retry/retryMiddleware.mjs");
/* harmony import */ var _aws_amplify_core_internals_aws_client_utils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @aws-amplify/core/internals/aws-client-utils */ "../core/dist/esm/clients/middleware/signing/middleware.mjs");
 ...
 * @internal
 */
const authenticatedHandler = (0,_aws_amplify_core_internals_aws_client_utils_composers__WEBPACK_IMPORTED_MODULE_0__.composeTransferHandler)(_aws_amplify_core_internals_aws_client_utils__WEBPACK_IMPORTED_MODULE_1__.fetchTransferHandler, [
    _aws_amplify_core_internals_aws_client_utils__WEBPACK_IMPORTED_MODULE_2__.userAgentMiddlewareFactory,
    _aws_amplify_core_internals_aws_client_utils__WEBPACK_IMPORTED_MODULE_3__.retryMiddlewareFactory,
    _aws_amplify_core_internals_aws_client_utils__WEBPACK_IMPORTED_MODULE_4__.signingMiddlewareFactory,
]);
...
/***/ "../api-rest/dist/esm/apis/common/baseHandlers/unauthenticatedHandler.mjs":
/*!********************************************************************************!*\
  !*** ../api-rest/dist/esm/apis/common/baseHandlers/unauthenticatedHandler.mjs ***!
  \********************************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
 ...
 * @internal
 */
const unauthenticatedHandler = (0,_aws_amplify_core_internals_aws_client_utils_composers__WEBPACK_IMPORTED_MODULE_0__.composeTransferHandler)(_aws_amplify_core_internals_aws_client_utils__WEBPACK_IMPORTED_MODULE_1__.fetchTransferHandler, [_aws_amplify_core_internals_aws_client_utils__WEBPACK_IMPORTED_MODULE_2__.userAgentMiddlewareFactory, _aws_amplify_core_internals_aws_client_utils__WEBPACK_IMPORTED_MODULE_3__.retryMiddlewareFactory]);
...
/* harmony import */ var _transferHandler_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./transferHandler.mjs */ "../api-rest/dist/esm/apis/common/transferHandler.mjs");
...
const post = (amplify, { url, options, abortController }) => {
    ...
    const responsePromise = (0,_utils_createCancellableOperation_mjs__WEBPACK_IMPORTED_MODULE_0__.createCancellableOperation)(async () => {
        const response = (0,_transferHandler_mjs__WEBPACK_IMPORTED_MODULE_4__.transferHandler)(amplify, {
            url,
            method: 'POST',
            ...options,
...
/* harmony import */ var _transferHandler_mjs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./transferHandler.mjs */ "../api-rest/dist/esm/apis/common/transferHandler.mjs");
...
const publicHandler = (amplify, options, method) => (0,_utils_createCancellableOperation_mjs__WEBPACK_IMPORTED_MODULE_0__.createCancellableOperation)(async (abortSignal) => {
    ...
    return (0,_transferHandler_mjs__WEBPACK_IMPORTED_MODULE_6__.transferHandler)(amplify, {
        ...apiOptions,
        url,
        method,
        headers,
...
/***/ "../api-rest/dist/esm/apis/common/transferHandler.mjs":
/*!************************************************************!*\
  !*** ../api-rest/dist/esm/apis/common/transferHandler.mjs ***!
  \************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _aws_amplify_core_internals_aws_client_utils__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @aws-amplify/core/internals/aws-client-utils */ "../core/dist/esm/clients/middleware/retry/defaultRetryDecider.mjs");
...
/* harmony import */ var _baseHandlers_authenticatedHandler_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./baseHandlers/authenticatedHandler.mjs */ "../api-rest/dist/esm/apis/common/baseHandlers/authenticatedHandler.mjs");
/* harmony import */ var _baseHandlers_unauthenticatedHandler_mjs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./baseHandlers/unauthenticatedHandler.mjs */ "../api-rest/dist/esm/apis/common/baseHandlers/unauthenticatedHandler.mjs");
...
const transferHandler = async (amplify, options, iamAuthApplicable, signingServiceInfo) => {
    ...
    if (isIamAuthApplicable && credentials) {
        ...
        response = await (0,_baseHandlers_authenticatedHandler_mjs__WEBPACK_IMPORTED_MODULE_5__.authenticatedHandler)(request, {
            ...baseOptions,
            credentials,
        ...
        response = await (0,_baseHandlers_unauthenticatedHandler_mjs__WEBPACK_IMPORTED_MODULE_6__.unauthenticatedHandler)(request, {
            ...baseOptions,
        });
    }
...
const getRetryDeciderFromStrategy = (retryStrategy) => {
    ...
    return (0,_aws_amplify_core_internals_aws_client_utils__WEBPACK_IMPORTED_MODULE_8__.getRetryDecider)(_utils_serviceError_mjs__WEBPACK_IMPORTED_MODULE_1__.parseRestApiServiceError);
};
