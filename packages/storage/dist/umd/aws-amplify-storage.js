...
const validateEchoedElements = (listInput, listOutput) => {
    ...
    if (!validEchoedParameters) {
        throw new _errors_IntegrityError_mjs__WEBPACK_IMPORTED_MODULE_11__.IntegrityError({ metadata: listOutput.$metadata });
    }
};
/**
...
/* harmony export */   serializeUploadOptions: () => (/* binding */ serializeUploadOptions)
/* harmony export */ });
/* harmony import */ var _utils_constants_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../../utils/constants.mjs */ "./dist/esm/providers/s3/utils/constants.mjs");
...
/* harmony import */ var _uploadCache_mjs__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./uploadCache.mjs */ "./dist/esm/providers/s3/apis/internal/uploadData/multipart/uploadCache.mjs");
...
/* harmony import */ var _initialUpload_mjs__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./initialUpload.mjs */ "./dist/esm/providers/s3/apis/internal/uploadData/multipart/initialUpload.mjs");
...
const getMultipartUploadHandlers = (uploadDataInput, size) => {
    ...
    const startUpload = async () => {
        ...
        const { checksum: optionsHash } = await (0,_utils_crc32_mjs__WEBPACK_IMPORTED_MODULE_7__.calculateContentCRC32)((0,_uploadCache_mjs__WEBPACK_IMPORTED_MODULE_8__.serializeUploadOptions)(uploadDataOptions));
        if (!inProgressUpload) {
            const { uploadId, cachedParts, finalCrc32 } = await (0,_initialUpload_mjs__WEBPACK_IMPORTED_MODULE_9__.loadOrCreateMultipartUpload)({
        ...
        uploadCacheKey = size
            ? (0,_uploadCache_mjs__WEBPACK_IMPORTED_MODULE_8__.getUploadsCacheKey)({
                file: data instanceof File ? data : undefined,
                accessLevel: resolvedAccessLevel,
        ...
        if (size) {
            const { ContentLength: uploadedObjectSize, $metadata } = await (0,_utils_client_s3data_headObject_mjs__WEBPACK_IMPORTED_MODULE_16__.headObject)(resolvedS3Config, {
                Bucket: resolvedBucket,
                Key: finalKey,
                ExpectedBucketOwner: expectedBucketOwner,
            });
        ...
        if (resumableUploadsCache && uploadCacheKey) {
            await (0,_uploadCache_mjs__WEBPACK_IMPORTED_MODULE_8__.removeCachedUpload)(resumableUploadsCache, uploadCacheKey);
        }
        const result = {
            eTag,
            contentType,
...
/* harmony import */ var _aws_amplify_core_internals_aws_client_utils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @aws-amplify/core/internals/aws-client-utils */ "../core/dist/esm/clients/middleware/retry/amzSdkInvocationIdHeaderMiddleware.mjs");
/* harmony import */ var _aws_amplify_core_internals_aws_client_utils__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @aws-amplify/core/internals/aws-client-utils */ "../core/dist/esm/clients/middleware/retry/retryMiddleware.mjs");
/* harmony import */ var _aws_amplify_core_internals_aws_client_utils__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @aws-amplify/core/internals/aws-client-utils */ "../core/dist/esm/clients/middleware/retry/amzSdkRequestHeaderMiddleware.mjs");
/* harmony import */ var _aws_amplify_core_internals_aws_client_utils__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @aws-amplify/core/internals/aws-client-utils */ "../core/dist/esm/clients/middleware/signing/middleware.mjs");
...
const s3TransferHandler = (0,_aws_amplify_core_internals_aws_client_utils_composers__WEBPACK_IMPORTED_MODULE_0__.composeTransferHandler)(_xhrTransferHandler_mjs__WEBPACK_IMPORTED_MODULE_1__.xhrTransferHandler, [
    ...
    _aws_amplify_core_internals_aws_client_utils__WEBPACK_IMPORTED_MODULE_4__.amzSdkInvocationIdHeaderMiddlewareFactory,
    _aws_amplify_core_internals_aws_client_utils__WEBPACK_IMPORTED_MODULE_5__.retryMiddlewareFactory,
    _aws_amplify_core_internals_aws_client_utils__WEBPACK_IMPORTED_MODULE_6__.amzSdkRequestHeaderMiddlewareFactory,
    _aws_amplify_core_internals_aws_client_utils__WEBPACK_IMPORTED_MODULE_7__.signingMiddlewareFactory,
]);
...
/* harmony import */ var _base_mjs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./base.mjs */ "./dist/esm/providers/s3/utils/client/s3data/base.mjs");
...
const abortMultipartUploadDeserializer = async (response) => {
    if (response.statusCode >= 300) {
        ...
        throw (0,_utils_deserializeHelpers_mjs__WEBPACK_IMPORTED_MODULE_5__.buildStorageServiceError)((await (0,_base_mjs__WEBPACK_IMPORTED_MODULE_6__.parseXmlError)(response)));
    }
    else {
        return {
...
const abortMultipartUpload = (0,_aws_amplify_core_internals_aws_client_utils_composers__WEBPACK_IMPORTED_MODULE_8__.composeServiceApi)(_runtime_s3TransferHandler_fetch_mjs__WEBPACK_IMPORTED_MODULE_9__.s3TransferHandler, abortMultipartUploadSerializer, abortMultipartUploadDeserializer, { ..._base_mjs__WEBPACK_IMPORTED_MODULE_6__.defaultConfig, responseType: 'text' });
...
const endpointResolver = (options, apiInput) => {
    ...
    if (customEndpoint) {
        ...
        endpoint = new _aws_amplify_core_internals_utils__WEBPACK_IMPORTED_MODULE_3__.AmplifyUrl(`https://${customEndpoint}`);
    }
...
const parseXmlBodyOrThrow = async (response) => {
    ...
    if (parsed.Code !== undefined && parsed.Message !== undefined) {
        ...
        throw (0,_utils_deserializeHelpers_mjs__WEBPACK_IMPORTED_MODULE_8__.buildStorageServiceError)(error);
    }
    return parsed;
};
const completeMultipartUploadDeserializer = async (response) => {
    if (response.statusCode >= 300) {
        // error is always set when statusCode >= 300
        throw (0,_utils_deserializeHelpers_mjs__WEBPACK_IMPORTED_MODULE_8__.buildStorageServiceError)((await (0,_base_mjs__WEBPACK_IMPORTED_MODULE_7__.parseXmlError)(response)));
    }
    else {
...
/* harmony import */ var fast_xml_parser__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! fast-xml-parser */ "?2abf");
/* harmony import */ var buffer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! buffer */ "?46b7");
/* harmony import */ var _utils_deserializeHelpers_mjs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../utils/deserializeHelpers.mjs */ "./dist/esm/providers/s3/utils/client/utils/deserializeHelpers.mjs");
/* harmony import */ var _utils_serializeHelpers_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/serializeHelpers.mjs */ "./dist/esm/providers/s3/utils/client/utils/serializeHelpers.mjs");
...
/* harmony import */ var _validateObjectUrl_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../validateObjectUrl.mjs */ "./dist/esm/providers/s3/utils/validateObjectUrl.mjs");
/* harmony import */ var _base_mjs__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./base.mjs */ "./dist/esm/providers/s3/utils/client/s3data/base.mjs");
...
const copyObjectDeserializer = async (response) => {
    if (response.statusCode >= 300) {
        // error is always set when statusCode >= 300
        throw (0,_utils_deserializeHelpers_mjs__WEBPACK_IMPORTED_MODULE_7__.buildStorageServiceError)((await (0,_base_mjs__WEBPACK_IMPORTED_MODULE_8__.parseXmlError)(response)));
    }
    else {
...
const deleteObjectDeserializer = async (response) => {
    if (response.statusCode >= 300) {
        ...
        const content = (0,_utils_deserializeHelpers_mjs__WEBPACK_IMPORTED_MODULE_5__.map)(response.headers, {
            DeleteMarker: ['x-amz-delete-marker', _utils_deserializeHelpers_mjs__WEBPACK_IMPORTED_MODULE_5__.deserializeBoolean],
            VersionId: 'x-amz-version-id',
            RequestCharged: [
                'x-amz-request-charged',
                (_utils_deserializeHelpers_mjs__WEBPACK_IMPORTED_MODULE_5__.deserializeStringTag),
            ],
        });
        return {
            ...content,
...
const deleteObject = (0,_aws_amplify_core_internals_aws_client_utils_composers__WEBPACK_IMPORTED_MODULE_8__.composeServiceApi)(_runtime_s3TransferHandler_fetch_mjs__WEBPACK_IMPORTED_MODULE_9__.s3TransferHandler, deleteObjectSerializer, deleteObjectDeserializer, { ..._base_mjs__WEBPACK_IMPORTED_MODULE_6__.defaultConfig, responseType: 'text' });
...
const getObjectDeserializer = async (response) => {
    if (response.statusCode >= 300) {
        ...
        return {
            ...(0,_utils_deserializeHelpers_mjs__WEBPACK_IMPORTED_MODULE_5__.map)(response.headers, {
                DeleteMarker: ['x-amz-delete-marker', _utils_deserializeHelpers_mjs__WEBPACK_IMPORTED_MODULE_5__.deserializeBoolean],
                AcceptRanges: 'accept-ranges',
                Expiration: 'x-amz-expiration',
                Restore: 'x-amz-restore',
                LastModified: ['last-modified', _utils_deserializeHelpers_mjs__WEBPACK_IMPORTED_MODULE_5__.deserializeTimestamp],
                ContentLength: ['content-length', _utils_deserializeHelpers_mjs__WEBPACK_IMPORTED_MODULE_5__.deserializeNumber],
                ETag: 'etag',
                ChecksumCRC32: 'x-amz-checksum-crc32',
                ChecksumCRC32C: 'x-amz-checksum-crc32c',
                ChecksumSHA1: 'x-amz-checksum-sha1',
                ChecksumSHA256: 'x-amz-checksum-sha256',
                MissingMeta: ['x-amz-missing-meta', _utils_deserializeHelpers_mjs__WEBPACK_IMPORTED_MODULE_5__.deserializeNumber],
                VersionId: 'x-amz-version-id',
                ...
                Expires: ['expires', _utils_deserializeHelpers_mjs__WEBPACK_IMPORTED_MODULE_5__.deserializeTimestamp],
                ...
                BucketKeyEnabled: [
                    ...
                    _utils_deserializeHelpers_mjs__WEBPACK_IMPORTED_MODULE_5__.deserializeBoolean,
                ],
                StorageClass: 'x-amz-storage-class',
                RequestCharged: 'x-amz-request-charged',
                ReplicationStatus: 'x-amz-replication-status',
                PartsCount: ['x-amz-mp-parts-count', _utils_deserializeHelpers_mjs__WEBPACK_IMPORTED_MODULE_5__.deserializeNumber],
                TagCount: ['x-amz-tagging-count', _utils_deserializeHelpers_mjs__WEBPACK_IMPORTED_MODULE_5__.deserializeNumber],
                ObjectLockMode: 'x-amz-object-lock-mode',
                ObjectLockRetainUntilDate: [
                    'x-amz-object-lock-retain-until-date',
                    _utils_deserializeHelpers_mjs__WEBPACK_IMPORTED_MODULE_5__.deserializeTimestamp,
                ],
                ObjectLockLegalHoldStatus: 'x-amz-object-lock-legal-hold',
            }),
            Metadata: (0,_utils_deserializeHelpers_mjs__WEBPACK_IMPORTED_MODULE_5__.deserializeMetadata)(response.headers),
            $metadata: (0,_aws_amplify_core_internals_aws_client_utils__WEBPACK_IMPORTED_MODULE_7__.parseMetadata)(response),
...
const getPresignedGetObjectUrl = async (config, input) => {
    const endpoint = _base_mjs__WEBPACK_IMPORTED_MODULE_6__.defaultConfig.endpointResolver(config, input);
    ...
    return (0,_aws_amplify_core_internals_aws_client_utils__WEBPACK_IMPORTED_MODULE_12__.presignUrl)({ method, url, body: undefined }, {
        signingService: _base_mjs__WEBPACK_IMPORTED_MODULE_6__.defaultConfig.service,
        signingRegion: config.region,
        ..._base_mjs__WEBPACK_IMPORTED_MODULE_6__.defaultConfig,
        ...config,
    });
};
...
const headObject = (0,_aws_amplify_core_internals_aws_client_utils_composers__WEBPACK_IMPORTED_MODULE_8__.composeServiceApi)(_runtime_s3TransferHandler_fetch_mjs__WEBPACK_IMPORTED_MODULE_9__.s3TransferHandler, headObjectSerializer, headObjectDeserializer, { ..._base_mjs__WEBPACK_IMPORTED_MODULE_6__.defaultConfig, responseType: 'text' });
...
/* harmony import */ var fast_xml_parser__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! fast-xml-parser */ "?2abf");
/* harmony import */ var buffer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! buffer */ "?46b7");
/* harmony import */ var _utils_deserializeHelpers_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../utils/deserializeHelpers.mjs */ "./dist/esm/providers/s3/utils/client/utils/deserializeHelpers.mjs");
/* harmony import */ var _utils_serializeHelpers_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/serializeHelpers.mjs */ "./dist/esm/providers/s3/utils/client/utils/serializeHelpers.mjs");
...
const listObjectsV2Deserializer = async (response) => {
    if (response.statusCode >= 300) {
        // error is always set when statusCode >= 300
        throw (0,_utils_deserializeHelpers_mjs__WEBPACK_IMPORTED_MODULE_4__.buildStorageServiceError)((await (0,_base_mjs__WEBPACK_IMPORTED_MODULE_5__.parseXmlError)(response)));
    }
    else {
        const parsed = await (0,_utils_parsePayload_mjs__WEBPACK_IMPORTED_MODULE_6__.parseXmlBody)(response);
        const contents = (0,_utils_deserializeHelpers_mjs__WEBPACK_IMPORTED_MODULE_4__.map)(parsed, {
            CommonPrefixes: [
                'CommonPrefixes',
                value => (0,_utils_deserializeHelpers_mjs__WEBPACK_IMPORTED_MODULE_4__.emptyArrayGuard)(value, deserializeCommonPrefixList),
            ],
            Contents: [
                'Contents',
                value => (0,_utils_deserializeHelpers_mjs__WEBPACK_IMPORTED_MODULE_4__.emptyArrayGuard)(value, deserializeObjectList),
            ],
            ContinuationToken: 'ContinuationToken',
            Delimiter: 'Delimiter',
            EncodingType: ['EncodingType', (_utils_deserializeHelpers_mjs__WEBPACK_IMPORTED_MODULE_4__.deserializeStringTag)],
            IsTruncated: ['IsTruncated', _utils_deserializeHelpers_mjs__WEBPACK_IMPORTED_MODULE_4__.deserializeBoolean],
            KeyCount: ['KeyCount', _utils_deserializeHelpers_mjs__WEBPACK_IMPORTED_MODULE_4__.deserializeNumber],
            MaxKeys: ['MaxKeys', _utils_deserializeHelpers_mjs__WEBPACK_IMPORTED_MODULE_4__.deserializeNumber],
            Name: 'Name',
...
const deserializeCommonPrefix = (output) => (0,_utils_deserializeHelpers_mjs__WEBPACK_IMPORTED_MODULE_4__.map)(output, {
    Prefix: 'Prefix',
});
const deserializeObjectList = (output) => output.map(deserializeObject);
const deserializeObject = (output) => (0,_utils_deserializeHelpers_mjs__WEBPACK_IMPORTED_MODULE_4__.map)(output, {
    Key: 'Key',
    LastModified: ['LastModified', _utils_deserializeHelpers_mjs__WEBPACK_IMPORTED_MODULE_4__.deserializeTimestamp],
    ETag: 'ETag',
    ChecksumAlgorithm: [
        'ChecksumAlgorithm',
        value => (0,_utils_deserializeHelpers_mjs__WEBPACK_IMPORTED_MODULE_4__.emptyArrayGuard)(value, deserializeChecksumAlgorithmList),
    ],
    Size: ['Size', _utils_deserializeHelpers_mjs__WEBPACK_IMPORTED_MODULE_4__.deserializeNumber],
    StorageClass: ['StorageClass', (_utils_deserializeHelpers_mjs__WEBPACK_IMPORTED_MODULE_4__.deserializeStringTag)],
    Owner: ['Owner', deserializeOwner],
});
const deserializeChecksumAlgorithmList = (output) => output.map((_utils_deserializeHelpers_mjs__WEBPACK_IMPORTED_MODULE_4__.deserializeStringTag));
const deserializeOwner = (output) => (0,_utils_deserializeHelpers_mjs__WEBPACK_IMPORTED_MODULE_4__.map)(output, { DisplayName: 'DisplayName', ID: 'ID' });
const validateCorroboratingElements = (response) => {
    ...
    if (!validTruncation || !validNumberOfKeysReturned) {
        throw new _errors_IntegrityError_mjs__WEBPACK_IMPORTED_MODULE_8__.IntegrityError({ metadata: response.$metadata });
    }
};
const listObjectsV2 = (0,_aws_amplify_core_internals_aws_client_utils_composers__WEBPACK_IMPORTED_MODULE_9__.composeServiceApi)(_runtime_s3TransferHandler_fetch_mjs__WEBPACK_IMPORTED_MODULE_10__.s3TransferHandler, listObjectsV2Serializer, listObjectsV2Deserializer, { ..._base_mjs__WEBPACK_IMPORTED_MODULE_5__.defaultConfig, responseType: 'text' });
...
const listPartsDeserializer = async (response) => {
    if (response.statusCode >= 300) {
        ...
        const contents = (0,_utils_deserializeHelpers_mjs__WEBPACK_IMPORTED_MODULE_4__.map)(parsed, {
            ...
            Parts: [
                'Part',
                value => (0,_utils_deserializeHelpers_mjs__WEBPACK_IMPORTED_MODULE_4__.emptyArrayGuard)(value, _utils_deserializeHelpers_mjs__WEBPACK_IMPORTED_MODULE_4__.deserializeCompletedPartList),
            ],
        });
        return {
            $metadata: (0,_aws_amplify_core_internals_aws_client_utils__WEBPACK_IMPORTED_MODULE_7__.parseMetadata)(response),
...
const listParts = (0,_aws_amplify_core_internals_aws_client_utils_composers__WEBPACK_IMPORTED_MODULE_8__.composeServiceApi)(_runtime_s3TransferHandler_fetch_mjs__WEBPACK_IMPORTED_MODULE_9__.s3TransferHandler, listPartsSerializer, listPartsDeserializer, { ..._base_mjs__WEBPACK_IMPORTED_MODULE_5__.defaultConfig, responseType: 'text' });
...
const putObject = (0,_aws_amplify_core_internals_aws_client_utils_composers__WEBPACK_IMPORTED_MODULE_8__.composeServiceApi)(_runtime_s3TransferHandler_fetch_mjs__WEBPACK_IMPORTED_MODULE_9__.s3TransferHandler, putObjectSerializer, putObjectDeserializer, { ..._base_mjs__WEBPACK_IMPORTED_MODULE_6__.defaultConfig, responseType: 'text' });
...
/* harmony export */   deserializeStringTag: () => (/* binding */ deserializeStringTag),
 ...
 * @internal
 */
const buildStorageServiceError = (error) => new _errors_StorageError_mjs__WEBPACK_IMPORTED_MODULE_0__.StorageError({
    name: error.name,
